...
<div class="container">
     <div class="copyright-txt">
		...
		<?php } ?>
        <?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','skt-generic');?> <a class="ftrlink" href="<?php echo esc_url('https://www.sktthemes.org/shop/free-generic-wordpress-theme');?>" target="_blank"><?php esc_html_e('SKT Generic','skt-generic'); ?>
        </a>
        </div>
     <div class="clear"></div>
</div>           
